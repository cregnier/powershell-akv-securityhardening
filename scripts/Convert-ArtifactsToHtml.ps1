...
<div style="margin-top: 40px; padding-top: 20px; border-top: 2px solid #e0e0e0; color: #666; font-size: 0.9em;">
    <p><strong>Generated by:</strong> Convert-ArtifactsToHtml.ps1 (JSON to HTML conversion)</p>
    <p><strong>Source:</strong> $($_.Name)</p>
...
if (Test-Path $csvDir){
    Get-ChildItem -Path $csvDir -Filter *.csv -File | ForEach-Object {
        ...
        $html += @"
<div style="margin-top: 40px; padding-top: 20px; border-top: 2px solid #e0e0e0; color: #666; font-size: 0.9em;">
    <p><strong>Generated by:</strong> Convert-ArtifactsToHtml.ps1 (CSV to HTML conversion)</p>
    <p><strong>Source:</strong> $($_.Name)</p>
    <p><strong>Timestamp:</strong> $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')</p>
</div>
"@
