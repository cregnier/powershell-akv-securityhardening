<#
Per-vault remediation script for kv-rbdeny-gjosgwvi
Usage: .\remediate-kv-rbdeny-gjosgwvi.ps1 -SubscriptionId <id> [-Apply]
#>
param(
...
$vaultName = 'kv-rbdeny-gjosgwvi'
$resourceId = '/subscriptions/ab1336c7-687d-4107-b0f6-9649a0458adb/resourceGroups/rg-policy-keyvault-test/providers/Microsoft.KeyVault/vaults/kv-rbdeny-gjosgwvi'
