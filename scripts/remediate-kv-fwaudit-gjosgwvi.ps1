<#
Per-vault remediation script for kv-fwaudit-gjosgwvi
Usage: .\remediate-kv-fwaudit-gjosgwvi.ps1 -SubscriptionId <id> [-Apply]
#>
param(
...
$vaultName = 'kv-fwaudit-gjosgwvi'
$resourceId = '/subscriptions/ab1336c7-687d-4107-b0f6-9649a0458adb/resourceGroups/rg-policy-keyvault-test/providers/Microsoft.KeyVault/vaults/kv-fwaudit-gjosgwvi'
...
$cmds = @(
    ...
    "Update-AzKeyVaultNetworkRuleSet -VaultName '$vaultName' -ResourceGroupName '$rg' -DefaultAction Deny -IpRule <allowed-ip-list>",
