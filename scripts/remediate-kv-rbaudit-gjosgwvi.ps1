<#
Per-vault remediation script for kv-rbaudit-gjosgwvi
Usage: .\remediate-kv-rbaudit-gjosgwvi.ps1 -SubscriptionId <id> [-Apply]
#>
param(
...
$vaultName = 'kv-rbaudit-gjosgwvi'
$resourceId = '/subscriptions/ab1336c7-687d-4107-b0f6-9649a0458adb/resourceGroups/rg-policy-keyvault-test/providers/Microsoft.KeyVault/vaults/kv-rbaudit-gjosgwvi'
