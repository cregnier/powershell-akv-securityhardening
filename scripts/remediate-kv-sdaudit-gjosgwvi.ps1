<#
Per-vault remediation script for kv-sdaudit-gjosgwvi
Usage: .\remediate-kv-sdaudit-gjosgwvi.ps1 -SubscriptionId <id> [-Apply]
#>
param(
...
$vaultName = 'kv-sdaudit-gjosgwvi'
$resourceId = '/subscriptions/ab1336c7-687d-4107-b0f6-9649a0458adb/resourceGroups/rg-policy-keyvault-test/providers/Microsoft.KeyVault/vaults/kv-sdaudit-gjosgwvi'
...
foreach ($c in $cmds) {
    try { Invoke-Expression $c } catch { Write-Host "Failed: $c - $_" -ForegroundColor Red }
}
